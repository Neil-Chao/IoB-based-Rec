...
class FMLPC(nn.Module):
    def __init__(self, item_size, ae, w, hidden_size=64, max_seq_length=5, hidden_dropout_prob=0.5, initializer_range=0.02,  num_hidden_layers=2, no_filters=False, num_attention_heads=2, attention_probs_dropout_prob=0.5, hidden_act="gelu", t=0.3, gamma1=5, gamma2=5):
        super(FMLPC, self).__init__()
        self.gamma1 = gamma1
        self.gamma2 = gamma2
