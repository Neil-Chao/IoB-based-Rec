...
class BERT4Rec(nn.Module):
    ...
    '''
    def __init__(self, bert_max_len, num_items, bert_num_blocks=2, bert_num_heads=4, bert_hidden_units=32, bert_dropout=0.1, bert_mask_prob=0.2) -> None:
        super().__init__()
