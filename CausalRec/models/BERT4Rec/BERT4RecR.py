...
class BERT4RecR(nn.Module):
    ...
    '''
    def __init__(self, bert_max_len, num_items, bert_num_blocks=2, bert_num_heads=4, bert_hidden_units=32, bert_dropout=0.5, bert_mask_prob=0.2, t=0.3, gamma1=5, gamma2=5) -> None:
        super().__init__()
        cluster = 16
        ...
        self.gamma1 = gamma1
        self.gamma2 = gamma2
        self.ae = nn.Parameter(torch.zeros(num_items, cluster).to(torch.float32), requires_grad=True)
