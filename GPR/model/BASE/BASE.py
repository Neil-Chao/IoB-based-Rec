...
from GPR.model.BASE.modules.GroupEmbedding import GroupEmbedding
from GPR.model.BASE.modules.PreferenceLayer import PreferenceLayer
    
class BASE(nn.Module):
    '''
    Group Personalized Recommendation
    '''
    def __init__(self, user_num, item_num, user_emb_size, item_emb_size, drop_prob=0.5) -> None:
        super().__init__()
        self.group_layer = GroupEmbedding(user_num+1, item_num+1, user_emb_size, item_emb_size)
    ...
    def forward(self, group_user, group_behavior, target_user, target_item):
        ...
        group_embedding = self.group_layer(group_user, group_behavior)
